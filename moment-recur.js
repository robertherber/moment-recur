(function (root, factory) {
  ...
  var Recur = (function () {
    ...
    Recur.prototype.save = function () {
      ...
      if (this.end && moment(this.end).isValid()) {
        data.end = this.end.format(dateFormat);
      }
    ...
    Recur.prototype.toJSON = Recur.prototype.save;
    ...
    for (var measure in measures) {
      if (ruleTypes.hasOwnProperty(measure)) {
        Recur.prototype[measures[measure]] = createMeasure(measure);
        Recur.prototype[measure] = Recur.prototype[measures[measure]];
      }
    }
  ...
  moment.fn.isSameDate = function (otherDate) {
    var formattedAsString = moment(otherDate).format(dateFormat),
      thisFormattedAsString = this.format(dateFormat);

    // just compare date string - handled by each respective timezone
    return formattedAsString === thisFormattedAsString;
  };
